        ...
        children: [
          ...
          const SizedBox(
           ...
           CustomTextFiled(
            ...
            contentPadding: const EdgeInsets.symmetric(vertical: 80, horizontal: 20),
          ),
          SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  if(formkey.currentState!.validate())
                  {
                    ...
                    NoteModel note = NoteModel(title: title!, content: content!, color: Colors.brown.value, date: DateTime.now().toString());
